                    ...
                    <div class="colorlib-narrow-content">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
                                <span class="heading-meta">instagram/linkedl/youtube</span>
                                <h2 class="colorlib-heading">sosyal medya</h2>
                            </div>
                        </div>
                        <!doctype html>
                        <html lang="en">
                        ...
                        <div class="main">
                            <div class="up">
                                <button class="card1" ><a href="https://www.instagram.com/{{$about->instagram}}/" target="_blank">
                                ...
                                <button class="card2"><a href="https://twitter.com/{{$about->twitter}}" target="_blank">
                            ...
                            <div class="down">
                                <button class="card3"><a href="https://github.com/{{$about->githup}}" target="_blank">
                                ...
                                <button class="card4"><a href="https://discord.com/{{$about->discord}}/" target="_blank">
