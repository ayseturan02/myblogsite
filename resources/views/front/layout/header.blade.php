    ...
    <div class="container-wrap">
        ...
        <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
            <div class="text-center">
                <div class="author-img" style="background-image: url({{asset("front/images/about.jpg")}});"></div>
                <h1 id="colorlib-logo"><a href="{{route("anasayfa")}}">AYŞE TURAN</a></h1>
                <span class="position"><a >YAZILIM MÜHENDİSLİĞİ </a> | FU </span>
            </div>
