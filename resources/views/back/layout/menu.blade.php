...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route("admin.dashboard")}}">
            <div class="sidebar-brand-text mx-3">blogsitesi Admin</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
               aria-expanded="true" aria-controls="collapseUtilities">
                ...
                <span>Fotoğraf ve Tablo içeriği</span>
            </a>
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Fotoğraflar ve Tablolar</h6>
                    <a class="collapse-item" href="#">Profil</a>
                    <a class="collapse-item" href="{{route("admin.fotograflar.index")}}">Anasayfa</a>
                    <a class="collapse-item" href="#">Galeri</a>
                    <a class="collapse-item" href="{{route("admin.yetenekler.index")}}">Yetenekler</a>
                </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{route("anasayfa")}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
